...
<span color="red">When you first access the webpage, you are greeted by the welcome page, prompting you to sign-up or log in. The image of the cocktail is randomly generated, each time you visit the page.</span>
